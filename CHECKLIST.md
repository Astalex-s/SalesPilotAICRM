...
> Статус: **В разработке** | Последнее обновление: 2026-05-01
...
- [ ] AI-анализ потерянных сделок (batch)
- [ ] AI-сводка по воронке (weekly digest)
...
- [x] Страница настроек пользователя (смена пароля, аватар, цвет аватара)
...
- [ ] Управление несколькими воронками через UI
...
**Где мы сейчас:**
Весь фундамент готов. Бэкенд полностью функционален (все домены, AI, Gmail, Telegram, GDPR, Auth).
Фронтенд — все страницы реализованы и работают с реальным API. Дизайн унифицирован (Stitch).
Последнее завершённое — Add Deal диалог с интеграцией AI + Gmail + Telegram.

**Следующий логичный шаг:**
1. Коммит всех несохранённых изменений с нормальными сообщениями
2. README.md — презентация проекта (для портфолио важно)
3. Health checks + docker-compose.dev.yml для удобной разработки
4. Пустые состояния и мобильная адаптация для polish
