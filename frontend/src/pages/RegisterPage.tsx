...
const WaveBg = () => (
  ...
  >
    ...
    {/* Deep cyan wave – bottom layer */}
    <path
      d="M-20 430 C80 340,220 500,380 400 C540 300,640 460,780 350 C840 310,880 320,920 310 L920 640 L-20 640 Z"
      fill="url(#waveBlue1)"
    />
    {/* Light cyan wave */}
    <path
      d="M-20 470 C60 380,180 520,340 430 C500 340,620 490,780 390 C840 355,880 360,920 350 L920 640 L-20 640 Z"
      fill="url(#waveCyan)"
    />
    {/* Pink wave – above */}
    <path
      d="M-20 390 C100 280,260 440,420 360 C580 280,680 420,820 330 C860 308,900 315,920 310 L920 640 L-20 640 Z"
      fill="url(#wavePink)"
    />
    {/* Bold blue wave – top */}
    <path
      d="M-20 360 C120 240,280 410,440 330 C600 250,700 390,860 300 L920 640 L-20 640 Z"
      fill="url(#waveBlue2)"
    />
    {/* Thin top-left accent */}
    <path
      d="M-20 0 C150 60,300 20,500 80 C650 130,750 60,920 100 L920 0 Z"
      fill="#B8E8FA" opacity="0.3"
    />
...
export default function RegisterPage() {
  ...
  return (
    <Box sx={{
      ...
      {/* Logo — top-left, blended so white bg disappears */}
      ...
      <Box sx={{
        ...
        <Box component="form" onSubmit={handleSubmit} sx={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
          {[
            { label: 'Имя', value: name, onChange: setName, type: 'text', autoFocus: true },
            { label: 'Email', value: email, onChange: setEmail, type: 'email' },
            { label: 'Пароль', value: password, onChange: setPassword, type: 'password' },
            { label: 'Подтвердите Пароль', value: confirm, onChange: setConfirm, type: 'password' },
          ...
          >
            {loading ? <CircularProgress size={22} color="inherit" /> : 'Регистрация'}
          </Button>
        </Box>
